...
As you can see we get the first two rows of the ANOVA table. The $p$-value is small meaning that we reject the null hypothesis at the $\alpha = 0.05$ significance level. The value of our $F$-statistic is `r unlist(anova(anovaObj)[4])[1]`. 
